            ...
            (accumulate(
                (x, ys) => is_null(ys)
                            ...
                            : list(
                                ...
                                ? get_y(x)
                                : get_y(ys),
                                get_width(x) > get_width(ys)
                                ? get_width(x)
                                : get_width(ys),
                                get_height(x) > get_height(ys)
                                ? get_height(x)
                                : get_height(ys)
                                ),
                null,
...
function overlap_area(aar1, aar2) {
    ...
    // WRITE YOUR SOLUTION HERE.
    return (get_x(aar1) <= get_x(aar2) + get_width(aar2) &&
            get_x(aar1) >= get_x(aar2)
            ? math_min(get_x(aar2) + get_width(aar2) - get_x(aar1),
                get_width(aar1))
            : get_x(aar2) <= get_x(aar1) + get_width(aar1) &&
            get_x(aar2) >= get_x(aar1)
            ? math_min(get_x(aar1) + get_width(aar1) - get_x(aar2),
                get_width(aar2))
            : 0) * 
            (get_y(aar1) <= get_y(aar2) + get_height(aar2) &&
            get_y(aar1) >= get_y(aar2)
            ? math_min(get_y(aar2) + get_height(aar2) - get_y(aar1),
                get_height(aar1))
            : get_y(aar2) <= get_y(aar1) + get_height(aar1) &&
            get_y(aar2) >= get_y(aar1)
            ? math_min(get_y(aar1) + get_height(aar1) - get_y(aar2),
                get_height(aar2))
            : 0);
}
